...
Catalog::Catalog(XRef *xrefA) {
  ...
  obj.free();
  pages = (Page **)malloc(pagesSize * sizeof(Page *));
  pageRefs = (Ref *)malloc(pagesSize * sizeof(Ref));
...
int Catalog::readPageTree(Dict *pagesDict, PageAttrs *attrs, int start) {
  ...
  for (i = 0; i < kids.arrayGetLength(); ++i) {
	...
	goto err3;
      ...
      if (start >= pagesSize) {
	pagesSize += 32;
	pages = (Page **)realloc(pages, pagesSize * sizeof(Page *));
	pageRefs = (Ref *)realloc(pageRefs, pagesSize * sizeof(Ref));
